  ...
  return (
    <div className="bg-brandColor ">
      <div className="container mx-auto h-11 flex items-center justify-between">
        ...
        <nav className="flex gap-x-8 text-base font-normal">
          <a
            href="#"
            className="flex justify-center items-center  gap-x-2 text-white transition-all opacity-75  hover:opacity-100"
          >
            <BiGlobe size={20} className="mr-3" />
            Türkçe (TR)
          </a>
          <a
            href="#"
